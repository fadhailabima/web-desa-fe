  ...
  return (
    <section
      className={`font-poppins px-5 z-30 transition-all duration-300 ease-in-out ${
        isSticky ? "fixed top-0 left-0 w-full bg-white shadow-md" : "fixed top-0 left-0 w-full"
      }`}
    >
      <CustomContainer>
        <div className="flex justify-between">
          ...
          <div className={`hidden lg:block ${isSticky ? "text-black" : "text-white"}`}>
            <Link
              href="/"
                  ...
                  <SheetDescription>
                    <div className="flex flex-col items-center">
                      <div className="flex my-4 font-medium items-center text-2xl text-primary bg-gray-100 px-4 py-2 rounded-lg">
                        <IoHome />
                        <Link href="/" className="ml-2">Beranda</Link>
                      </div>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="flex my-4 font-medium items-center text-2xl text-primary bg-gray-100 px-4 py-2 rounded-lg">
                        <FaInfoCircle />
                        <Link href="/tentang" className="ml-2">Tentang</Link>
                      </div>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="flex my-4 font-medium items-center text-2xl text-primary bg-gray-100 px-4 py-2 rounded-lg">
                        <BiSolidVideos />
                        <Link href="/kumpulan-video" className="ml-2">Kumpulan Video</Link>
                      </div>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="flex my-4 font-medium items-center text-2xl text-primary bg-gray-100 px-4 py-2 rounded-lg">
                        <IoIosDocument />
                        <Link href="/blog" className="ml-2">Blog</Link>
                      </div>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="flex my-4 font-medium items-center text-2xl text-primary bg-gray-100 px-4 py-2 rounded-lg">
                        <IoIosDocument />
                        <Link href="/temukan-kami" className="ml-2">Temukan Kami</Link>
                      </div>
                    </div>
                  </SheetDescription>
                </SheetHeader>
